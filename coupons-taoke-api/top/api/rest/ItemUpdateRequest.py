...
class ItemUpdateRequest(RestApi):
	...
	def getTranslateParas(self):
		return {'food_security_factory_site':'food_security.factory_site','locality_life_eticket':'locality_life.eticket','ms_payment_reference_price':'ms_payment.reference_price','food_security_factory':'food_security.factory','food_security_design_code':'food_security.design_code','location_state':'location.state','food_security_stock_date_end':'food_security.stock_date_end','locality_life_packageid':'locality_life.packageid','food_security_supplier':'food_security.supplier','locality_life_refund_ratio':'locality_life.refund_ratio','paimai_info_deposit':'paimai_info.deposit','locality_life_refundmafee':'locality_life.refundmafee','location_city':'location.city','paimai_info_valid_hour':'paimai_info.valid_hour','food_security_product_date_start':'food_security.product_date_start','food_security_mix':'food_security.mix','locality_life_choose_logis':'locality_life.choose_logis','food_security_prd_license_no':'food_security.prd_license_no','locality_life_verification':'locality_life.verification','food_security_stock_date_start':'food_security.stock_date_start','delivery_time_delivery_time':'delivery_time.delivery_time','food_security_product_date_end':'food_security.product_date_end','locality_life_network_id':'locality_life.network_id','paimai_info_mode':'paimai_info.mode','food_security_health_product_no':'food_security.health_product_no','paimai_info_interval':'paimai_info.interval','food_security_contact':'food_security.contact','locality_life_version':'locality_life.version','paimai_info_valid_minute':'paimai_info.valid_minute','food_security_food_additive':'food_security.food_additive','locality_life_merchant':'locality_life.merchant','delivery_time_need_delivery_time':'delivery_time.need_delivery_time','ms_payment_voucher_price':'ms_payment.voucher_price','paimai_info_reserve':'paimai_info.reserve','delivery_time_delivery_time_type':'delivery_time.delivery_time_type','locality_life_onsale_auto_refund_ratio':'locality_life.onsale_auto_refund_ratio','locality_life_expirydate':'locality_life.expirydate','locality_life_obs':'locality_life.obs','ms_payment_price':'ms_payment.price','food_security_period':'food_security.period','food_security_plan_storage':'food_security.plan_storage'}
